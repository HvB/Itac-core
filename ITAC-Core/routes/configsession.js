	...
	router.route( '/' )
	    ...
	    .get( function(req, res,next) 
	    	...
	    	console.log(BaseAuthentification.Authenticator.registredAuthenticators());
	  	  	res.render('configsession', { title: 'Express', ipserver:host, factories:BaseAuthentification.Authenticator.registredFactories(), authenticators:BaseAuthentification.Authenticator.registredAuthenticators() });
	  	  	}
	    )
